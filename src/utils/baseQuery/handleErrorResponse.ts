...
export type Handler = (api: BaseQueryApi, code?: number, message?: string, silent?: boolean) => void;

const errorHandlers: Record<number, Handler> = {
    401: handle401
}

const handleErrorResponse = (api: BaseQueryApi, code: number, data?: { message?: string }, silent?: boolean): { error: FetchBaseQueryError } => {
